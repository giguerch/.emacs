;; Fichier de configuration (.emacs) de Charles-Édouard Giguère.
...
;; ---- Petit tirage pour varier le thème d'une journée à l'autre ---- 
;; ===================================================================
;; chiffre de 0 à 1. 
...
;; ---- Section qui définit des shortcuts et des petits scripts ---
;; ================================================================
...
;; ---- Mode pour avoir les fichiers récents sur lesquels ont a travaillé ----
;; ===========================================================================
(recentf-mode 1)
